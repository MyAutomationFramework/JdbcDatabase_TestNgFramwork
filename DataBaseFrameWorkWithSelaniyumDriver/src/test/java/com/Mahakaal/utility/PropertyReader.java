...
public class PropertyReader {
 ...
 FileInputStream       read_dataProperties  =new FileInputStream(System.getProperty("user.dir")+"//src//test//java//com//Mahakaal//properties//"+envProperties_value.getProperty("env")+"-data.properties");
   ...
   FileInputStream       read_databaseProperties  =new FileInputStream(System.getProperty("user.dir")+"//src//test//java//com//Mahakaal//properties//"+envProperties_value.getProperty("env")+"-database.properties");
